	...
	<div class="container">
		...
		<form class="form-horizontal" action="/boardModify">
			<input type="hidden" id="boardNum" name="boardNum"
				value="${boardDetail.BOARDNUM}">
			<div class="form-group">
				<label class="control-label col-sm-2" for="nickname">닉네임:</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="nickname"
						value="${boardDetail.WRITER}" name="nickname" readonly>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="password"
						value="${boardDetail.PASSWORD}" name="password" readonly>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="title"
						value="${boardDetail.TITLE}" name="title">
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<div class="checkbox">
						<label style="font-weight: 700;"><input type="checkbox"
							name="remember">비밀번호 저장</label>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-offset-2 col-sm-10">
					<textarea class="form-control" rows="20" cols="20" id="content"
						name="content">${boardDetail.CONTENT}</textarea>
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-default" id="writeBtn"
						style="font-weight: 700;">수정완료</button>
				</div>
			</div>
		</form>
	</div>
